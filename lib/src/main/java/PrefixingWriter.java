 ...
 *
 * <p>Primarily, this class supports {@link TreeWriter}, which provides a higher-level interface
 * for outputting tree structures. {@code PrefixingWriter} can be used without {@code TreeWriter},
 * though you may still want to wrap it in a standard {@link PrintWriter}.
 *
